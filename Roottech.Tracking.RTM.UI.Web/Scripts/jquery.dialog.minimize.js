...
(function ($) {
    ...
    $.ui.dialog.prototype._init = function () {
        ...
        this.titlebarHeight =
        // edited by asif on 2013-02-05 coz if autoOpen = false height is zero
            ((parseInt(uiDialogTitlebar.css('height')) == 0) ? 17 : parseInt(uiDialogTitlebar.css('height'))) 
                + parseInt(uiDialogTitlebar.css('padding-top')) + parseInt(uiDialogTitlebar.css('padding-bottom')) + parseInt(this.uiDialog.css('padding-top')) + parseInt(this.uiDialog.css('padding-bottom'));
