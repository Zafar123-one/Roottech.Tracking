...
{
    [Authorize]
    public class TestOwinController : ApiController
    {
        ...
        public static Token GetAccessToken(string clientId, string clientSecret, string username, string password)
        {
            ...
            {
                token.Error =
                    "GetAccessToken failed likely due to an invalid client ID, client secret, or invalid usrename and password";
            }
            return token;
        }
        ...
        public static Token GetAccessTokenByRefreshToken(string clientId, string clientSecret, string refreshToken)
        {
            ...
            {
                token.Error =
                    "GetAccessToken by Refresh Token failed likely due to an invalid client ID, client secret, or it has been revoked by the system admin";
            }
            return token;
        }
