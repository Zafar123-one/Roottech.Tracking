...
using Roottech.Tracking.PdfRpt.ColumnsItemsTemplates;
using Roottech.Tracking.PdfRpt.Core.Contracts;

namespace Roottech.Tracking.PdfRpt.Core.Helper
{
    /// <summary>
    ...
    public static class TableHelper
    {
        ...
        {
            return AddBorderToTable(table, BaseColor.LIGHT_GRAY, 0);
        }
